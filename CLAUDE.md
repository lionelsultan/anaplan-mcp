...
# OAuth - device grant (Claude shows URL+code in chat; user authorizes in browser then retries)
ANAPLAN_CLIENT_ID=...

# OAuth - refresh token (skip device grant using previously obtained refresh token)
ANAPLAN_CLIENT_ID=...
ANAPLAN_REFRESH_TOKEN=...
